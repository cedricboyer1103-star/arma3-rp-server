...
*/
class TP_IphoneXI_SettingsDefault {
   idd = 04202000;
   name = "TP_IphoneXI_SettingsDefault";
   movingenable = 1;
   enablesimulation = 1;
   ...
   class controls
   {
       ...
       class airplaneMode : Life_Checkbox
       {
           idc = 04202011;
           tooltip = "";
           oncheckedchanged = "['planemode',(_this select 1),04202000] call the_programmer_iphone_xi_fnc_settings_settingsCheckedChange;";
       ...
       class footVDistance : Life_RscEditIphoneXI
       {
           idc = 04202003;
           text = "";
           onkeyup = "[(_this select 0),'ground','default'] call the_programmer_iphone_xi_fnc_settings_settingsKeyUP;";
           x = 0.78 * safezoneW + safezoneX;
           y = 0.45330383480826 * safezoneH + safezoneY;
           w = 0.07 * safezoneW;
       ...
       class carVDistance : Life_RscEditIphoneXI
       {
           idc = 04202004;
           text = "";
           onkeyup = "[(_this select 0),'vehicle','default'] call the_programmer_iphone_xi_fnc_settings_settingsKeyUP;";
           x = 0.78 * safezoneW + safezoneX;
           y = 0.483097345132744 * safezoneH + safezoneY;
           w = 0.07 * safezoneW;
           h = 0.0284575575221236 * safezoneH;
           colortext[] = {0,0,0,1};
       };
       class airVDistance : Life_RscEditIphoneXI
       {
           idc = 04202005;
           text = "";
           onkeyup = "[(_this select 0),'air','default'] call the_programmer_iphone_xi_fnc_settings_settingsKeyUP;";
           x = 0.78 * safezoneW + safezoneX;
           y = 0.513539823008849 * safezoneH + safezoneY;
           w = 0.07 * safezoneW;
           h = 0.0284575575221236 * safezoneH;
           colortext[] = {0,0,0,1};
       };
       class grassNo : Life_RscButtonInvisibleIphoneXI
       {
           ...
           y = 0.569587020648969 * safezoneH + safezoneY;
       ...
       {
           x = 0.6484375 * safezoneW + safezoneX;
           y = 0.598877742379547 * safezoneH + safezoneY;
           w = 0.181770833333333 * safezoneW;
           h = 0.0284575575221236 * safezoneH;
           idc = -1;
       ...
       {
           x = 0.6484375 * safezoneW + safezoneX;
           y = 0.629359551622419 * safezoneH + safezoneY;
           w = 0.181770833333333 * safezoneW;
           h = 0.0284575575221236 * safezoneH;
           idc = -1;
       ...
       {
           x = 0.6484375 * safezoneW + safezoneX;
           y = 0.659841360865291 * safezoneH + safezoneY;
           w = 0.181770833333333 * safezoneW;
           h = 0.0284575575221236 * safezoneH;
           idc = -1;
       ...
       {
           x = 0.6484375 * safezoneW + safezoneX;
           y = 0.834129793510324 * safezoneH + safezoneY;
           w = 0.181770833333333 * safezoneW;
           h = 0.0284575575221236 * safezoneH;
           idc = -1;
