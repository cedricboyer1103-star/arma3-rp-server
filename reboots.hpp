...
*/
class TP_IphoneXI_Reboots {
   idd = 04200800;
   name = "TP_IphoneXI_Reboots";
   movingenable = 0;
   enablesimulation = 1;
   ...
   class controls
   {
       class rebootsGroup : Life_RscControlsGroupNoScrollbars
       {
           idc = 04200803;
           x = 0.648281 * safezoneW + safezoneX;
           y = 0.394 * safezoneH + safezoneY;
           w = 0.1814065 * safezoneW;
           h = 0.50 * safezoneH;
           class controls {};
       };
